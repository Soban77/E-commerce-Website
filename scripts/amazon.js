...
function renderProductsGrid() {
  ...
  document.querySelectorAll('.js-add-to-cart').forEach((button) => {
    ...
    button.addEventListener('click', () => {
      ...
      addMessage.classList.add('cart-message');
      ...
      setTimeout(() => {
        ...
        const timeId = setTimeout(() => {
          ...
          addMessage.classList.remove('cart-message');
...
function searching() {
  ...
  search.addEventListener('click', () => {
    ...
    products.forEach((product) => {
      ...
      if(product.name.includes(value) || product.name.includes(capValue) || product.name.includes(lowValue))
      {
